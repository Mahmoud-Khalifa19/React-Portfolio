...
const About = () => {
  return (
    ...
    <p>Hi, I'm Mahmoud a React Developer, nice to meet you. Please feel free to browse my portfolio and get some ideas about how I can build you the next project of your dreams.</p>
    </div>
    <div>
